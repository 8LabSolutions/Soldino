...
class CartProduct extends Component {
  enableRemove(title, quantity, price, VAT, sellerName, sellerVATNumber, keyProd, seller, description) {
    let product = [title, quantity, price, VAT, sellerName, sellerVATNumber, keyProd, seller, description]
    return (
          ...
          <div className="card-body">
            <div className="container">
              <div className="row">
                ...
                <div className="col-sm-4">
                  { props.quantity<="1" ? this.disableRemove() : this.enableRemove(props.title, +props.quantity-1, props.price, props.VAT, props.sellerName, props.sellerVATNumber, props.keyProd, props.seller, props.description) }
                </div>
                <div className="col-sm-4">
