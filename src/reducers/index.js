...
export function rootReducer(state = initialState, action) {
  ...
  if(action.type === RESETINVOICES || action.type === RESETVAT) {
    return Object.assign({}, state, {
      invoices: [],
      selectedPeriod: {id: "Select a quarter", amount: null, payable: false},
      VATRefundList: []
